...
const PaletteIcons = {
  ...
  chess: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#a3a3a3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9 7.5C7 9 6.5 12 7.5 14L5.5 19.5h13L16.5 14c1-2 .5-5-1.5-6.5"/>
      <path d="M4.5 19.5h15"/>
      <path d="M4.5 22h15"/>
    </svg>
  ),
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: PaletteIcons.chess, label: <><span>Challenge me</span><span style={{ color: '#c8c8c8', margin: '0 6px' }}>·</span><span style={{ color: '#ababab' }}>Rapid 15 mins</span></>, href: 'https://www.chess.com/member/joonseo123' },
